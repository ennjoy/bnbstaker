...
<template>
    <div class="flex items-center p-4 rounded-lg shadow-xs bg-gray-800">
        <div class="p-2 mr-4 rounded-full text-orange-100 bg-[#F00500]">
            ...
            <g id="Group_938" transform="translate(-953.348 -232.003)">
                <g id="Group_931">
                    <path id="Path_8573" style="fill: #F00500" d="M1423.2,289.1c-16.7,16.7-32,34.8-45.6,54.1l-4.3-1.4c-24.8-8.1-50.5-13.1-76.4-14.8
                    ...
                    <path id="Path_8574" style="fill: #F00500" d="M1578,668.4c-12.6,35.9-31.5,69.2-56,98.2c-13.3,15.6-28,29.9-43.8,42.9
                ...
                <path id="Path_8579" style="fill: #FFFFFF" d="M1551.4,627.9c-0.1-0.4-0.1-1.1-0.2-2.2c-24-2.6-92.5-4.2-156.1,48.3c0,0-20.5-94-116.5-94
                ...
                <path id="Path_8580" style="fill: none" d="M995,624.1c-6.3,0.9-10,1.9-10,1.9"/>
                <path id="Path_8581" style="fill: none" d="M1560.1,627c0,0-3.2-0.7-8.9-1.3"/>
                <path id="Path_8582" style="fill: #FFA409" d="M1550.6,617.7c-0.2-4.5-0.6-10.8-0.9-13.9c-4.3-45.4-15.9-82.5-37.9-121.8
                ...
                <path id="Path_8583" style="fill: none" d="M1377.6,343.2c-0.2,0.2-0.3,0.5-0.5,0.7"/>
                <path id="Path_8584" style="fill: none" d="M1509.1,476.9c-0.5,1.4-0.7,2.1-0.7,2.1"/>
                <g id="Group_934">
                    <g id="Group_933">
                        <g id="Group_932">
                            <path id="Path_8585" style="fill: #FF9300" d="M1518.1,296.1c-7.8-1-44.7-1.2-86.5,77.1l-0.2-0.1c-16.8-13.4-29.4-19.7-29.4-19.7
                                c66.1-76,107-80.2,107-80.2C1513.6,279.3,1516.5,287.1,1518.1,296.1z"/>
                        </g>
                        <path id="Path_8586" style="fill: #FF8300" d="M1491.3,443.1c-15.2-27-35.4-50.7-59.7-69.9c41.8-78.3,78.6-78.1,86.5-77.1c0,0,0,0,0,0
                            C1527.4,349.6,1491.3,443.1,1491.3,443.1z"/>
                        <path id="Path_8587" style="fill: #FF8300" d="M1519.6,296.4c-0.5-0.1-1-0.2-1.5-0.3L1519.6,296.4z"/>
                    </g>
                </g>
                <path id="Path_8588" style="fill: none" d="M1175.1,347.1c-1-1.4-2.1-2.8-3.1-4.2"/>
                <path id="Path_8589" style="fill: none" d="M1035,480.8c1.1,3.4,1.8,5.2,1.8,5.2"/>
                <g id="Group_937">
                    <g id="Group_936">
                        <g id="Group_935">
                            <path id="Path_8590" style="fill: #FF9300" d="M1146.2,353.4c0,0-13,6.3-30.4,19.7c0,0-0.1,0.1-0.2,0.1c-43.3-78.4-81.4-78.1-89.6-77.1
                                c1.6-9,4.6-16.9,9.3-22.9C1035.4,273.2,1077.8,277.4,1146.2,353.4z"/>
                        </g>
                        <path id="Path_8591" style="fill: #FF8300" d="M1115.7,373.2c-19,14.6-43.2,37.5-61.8,69.9c0,0-37.4-93.5-27.8-147c0,0,0,0,0,0
                            C1034.2,295.1,1072.4,294.9,1115.7,373.2z"/>
                        <path id="Path_8592" style="fill: #FF8300" d="M1026.1,296.1c-0.5,0.1-1.1,0.2-1.6,0.3L1026.1,296.1z"/>
                    </g>
                </g>
                <path id="Path_8593" style="fill: #FFFFFF" d="M1390.1,495c0,0-32,2-28-23s29-28,36-27s35,11,30,32s-12,17-16,18S1390.1,495,1390.1,495z"/>
                <path id="Path_8594" style="fill: #FFFFFF" d="M1154.1,495c0,0-32,2-28-23s29-28,36-27s35,11,30,32s-12,17-16,18S1154.1,495,1154.1,495z"/>
            </g>
        </svg>
        ...
        <div>
            <p class="flex items-center mb-2 text-sm font-medium whitespace-nowrap text-gray-400">
                {{ t('total-invested') }} (SHIB) <span class="text-lg ml-1 font-semibold text-gray-200">{{ useAbbreviate(parseFloat(totalInvested).toFixed(2)) }}</span>
            </p>

            <p class="flex items-center mb-2 text-sm font-medium whitespace-nowrap text-gray-400">
                {{ t('total-withdrawn') }} (SHIB) <span class="text-lg ml-1 font-semibold text-gray-200">{{ useAbbreviate(parseFloat(totalWithdrawn).toFixed(2)) }}</span>
            </p>
        </div>
    </div>
</template>