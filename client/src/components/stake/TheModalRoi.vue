            ...
            >
                <div class="inline-block w-full max-w-xl my-8 overflow-hidden text-left align-middle transition-all transform bg-[#1e2025] shadow-xl rounded-2xl">
                    <DialogTitle as="div" class="flex justify-between p-6 text-lg font-medium leading-6 text-white bg-[#23252b]">
                        <div class="text-xl font-medium text-[#838994]">{{ t('roi') }}</div>
                    ...
                    <div class="card-content text-[#838994]">
                        <div class="his-title">
                            <div>{{ t('days') }}</div>
                            <div class="uppercase">{{ t('roi') }}</div>
                            <div>{{ t('income-per-one') }} {{ token }}</div>
                        </div>

                        <div class="his-item">
                            <div>1</div>
                            <div>{{ plan.daily }}%</div>
                            <div>{{ plan.daily / 100 }}</div>
                        </div>
                        
                        <div class="modal-bottom" style="text-align: center;">
                            {{ t('calculated-based-on-compounding') }}
                        </div>
                    </div>
