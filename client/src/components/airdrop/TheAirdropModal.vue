                    ...
                    >
                        <div class="inline-block w-full max-w-xl my-8 overflow-hidden text-left align-middle transition-all transform bg-[#1e2025] shadow-xl rounded-2xl">
                            <DialogTitle as="div" class="flex justify-between p-6 text-lg font-medium leading-6 text-white bg-[#23252b]">
                                <div class="text-xl font-medium text-[#838994]">{{ t('airdrop') }} USDT</div>
                            ...
                            <div class="flex justify-center items-center card-content py-8">

                                <button @click="airdrop.airdrop()" class="base-btn pane-btn v-btn v-btn--is-elevated v-btn--has-bg theme--light v-size--default" type="button">
                                    <span class="v-btn__content">
                                        <Loading v-if="airdrop.loading" class="h-5 w-5 border-gray-900" />
                                        <span v-else class="uppercase">{{ t('get') }}</span>
                                    </span>
                                </button>
