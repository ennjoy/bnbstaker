...
contract BNBSTAKER_DOGE {
    using SafeMath for uint256;

    address doge = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    IBEP20 token;

    uint256 public constant INVEST_MIN_AMOUNT = 77 ether; // 77 doge
    ...
    /*! anti-whale */
    uint256 constant public MAX_WITHDRAW = 20000000 ether; // 20000000 doge max
    ...
    constructor() public {
      ...
      plans.push(Plan(15, 100)); // 30 days 10% daily // 150%
    ...
    function withdraw() public {
      ...
      token.transfer(msg.sender, totalAmount.mul(80).div(PROJECT_FEE));
